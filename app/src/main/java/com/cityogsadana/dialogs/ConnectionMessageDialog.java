...
public class ConnectionMessageDialog extends DialogFragment {
    ...
    public void successShowExtra(final TestActivity activity, String title, String message, String button, boolean b) {
        try {
            dialog = new Dialog(activity);
            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
            dialog.setContentView(R.layout.dialog_alert);
            ...
            okButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    dialog.dismiss();
                    Intent intent = new Intent(activity, ExtraOneActivity_.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    activity.startActivity(intent);
                    activity.finish();
                }
